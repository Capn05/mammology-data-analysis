...
# Create a dictionary for integration into a dataframe
...
# Perform linear regression and print slope and intercept
...
# Calculate the sum of negative distances    
state_to_distance = {}
...
for num in neg_dict.values():
    sum += num
print(sum)
# Calculate proportions of negative distances and store them in a dictionary
pps = {}
pps = {}
for state,value in neg_dict.items():
    ...
    pps[state]= [portion]
print(pps)
# Create a data frame from the proportions dictionary
...
# Plot the proportions using squarify
import squarify
